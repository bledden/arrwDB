"""Rust KD-Tree Index Wrapper - 15x faster search"""
...
class RustKDTreeIndexWrapper(VectorIndex):
    """Wrapper for Rust KD-Tree implementation."""
    ...
    def __init__(self, vector_store: VectorStore, rebuild_threshold: int = 100):
        ...
        self._rust_index = rust_hnsw.RustKDTreeIndex(
    ...
    def supports_incremental_updates(self) -> bool:
        return False  # KD-Tree needs rebuilding
    ...
    def __repr__(self) -> str:
        return f"RustKDTreeIndex(size={self.size()}, dimension={self._vector_store.dimension})"
